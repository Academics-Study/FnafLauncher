...
const steamlinks = [
    ...
    "https://academics-study.github.io/hd_fnaf/w/",
    "'javascript:alert('Sorry! We have not added a way to launch Sister Location yet...');',
    'https://academics-study.github.io/hd_fnaf/ps/',
    'https://academics-study.github.io/hd_fnaf/ucn/',
    "'javascript:alert('Sorry! We have not added a way to launch Help Wanted yet...');',
   "'javascript:alert('Sorry! We have not added a way to launch Security Breach yet...');',
   "'javascript:alert('Sorry! We have not added a way to launch Help Wanted 2 yet...');',
]
const htmllinks = [
   'https://academics-study.github.io/hd_fnaf/1/',
    'https://academics-study.github.io/hd_fnaf/2/',
